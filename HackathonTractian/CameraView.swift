...
struct CameraView: View {
    ...
    @State private var isNavigationSecondActive = false
                        ...
                        if camera.isTaken {
                            ...
                            if let finalImage = camera.finalImage {
                                ...
                                Button(action: {
                                    ...
                                    .background(
                                        NavigationLink(destination: SecondPhotoView(classifierManager: classifierManager, image1: finalImage), isActive: $isNavigationSecondActive) {
                                            EmptyView()
                                        }
                                            .hidden()
                                    )
